  ...
  return (
    <Center>
      <Box
        ...
        padding={4}
      >
        <Heading>Privacy Policy in German</Heading>
        <Box padding={4}>
          ...
          E-Mail-Adresse:{" "}
          <p>
            <a href="mailto:thomas.e.woehrle@gmail.com">
              thomas.e.woehrle@gmail.com
            </a>
          </p>
          ...
          <ul>
            ...
            <li>
              ...
              <strong>Dienstanbieter:</strong> Die Google Fonts werden auf
